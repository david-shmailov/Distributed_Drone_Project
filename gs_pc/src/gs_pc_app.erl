...
start(_StartType, _StartArgs) ->
    ...
    gen_server:call(gs_server, {set_waypoints, [ {?WORLD_SIZE/4,?WORLD_SIZE/4}, {?WORLD_SIZE/4,3*?WORLD_SIZE/4}, {3*?WORLD_SIZE/4,3*?WORLD_SIZE/4},{3*?WORLD_SIZE/4,?WORLD_SIZE/4}]}),
